...
const LoginPage: React.FC<LoginPageProps> = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // we'll update this route to exact dashboard link once built e.g., '/dashboard'
    navigate('/onboarding/welcome'); 
  };

  return (
    <div className="bg-[#FFFCFB] dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen flex items-center justify-center p-4 font-display">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input required className="w-full pl-12 pr-4 py-3.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all outline-none" id="email" placeholder="name@example.com" type="email" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input required className="w-full pl-12 pr-12 py-3.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all outline-none" id="password" placeholder="Enter your password" type={showPassword ? "text" : "password"} />
                <button 
            ...
            {/* Action Button */}
            <button className="w-full bg-primary hover:bg-blue-800 text-white font-bold py-4 rounded-lg shadow-lg shadow-primary/30 transition-all active:scale-[0.98]" type="submit">
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-md text-center group">
            <div className="mb-8 relative inline-block group-hover:scale-105 transition-transform duration-500">
              ...
              <div className="w-72 h-72 rounded-full bg-primary/5 flex items-center justify-center mx-auto border-4 border-white dark:border-slate-700 shadow-2xl overflow-hidden" 
                   style={{backgroundImage: `url('${loginPageData.heroImg}')`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
              </div>
              
              {/* Stats Badge Over Image */}
              <motion.div 
