          ...
          <main className="flex-1 flex flex-col items-center py-8 md:py-16 px-4">
            <div className="w-full max-w-[640px] flex flex-col gap-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {conditionsList.map((condition, idx) => (
                      ...
                      >
                        ...
                        <input 
                          className="h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary focus:ring-offset-0 transition-all checked:bg-[url('data:image/svg+xml;utf8,%3Csvg%20viewBox=%220%200%2016%2016%22%20fill=%22white%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cpath%20d=%22M12.207%204.793a1%201%200%20010%201.414l-5%205a1%201%200%2001-1.414%200l-2-2a1%201%200%20011.414-1.414L6.5%209.086l4.293-4.293a1%201%200%20011.414%200z%22/%3E%3C/svg%3E')] checked:bg-center checked:bg-no-repeat" 
                          type="checkbox"
              ...
              >
                ...
                <button 
                  onClick={handleNext}
                  className="w-full sm:w-auto sm:flex-[2] flex items-center justify-center gap-2 h-12 rounded-xl bg-primary text-white font-bold hover:bg-primary/90 shadow-md shadow-primary/20 transition-all group"
                >
                  Complete Profile
