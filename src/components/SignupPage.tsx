              ...
              >
                ...
                >
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                    Welcome to HeartGuard{createdUser.full_name ? `, ${createdUser.full_name.split(' ')[0]}` : ''}! Your account has been created for <span className="font-semibold text-slate-700 dark:text-slate-300">{createdUser.email}</span>.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-primary text-left leading-relaxed">
                    After logging in, you'll complete a short health profile and initial assessment so we can personalise your heart risk insights.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xs text-slate-400">
                    Redirecting automatically in <span className="font-bold text-slate-600 dark:text-slate-300">{countdown}s</span>
                  </p>
                </motion.div>
              </motion.div>
            ) : (
